      ...
      upData() {
            ...
            },
            {
              ...
              itemStyle: {
                color: {
                  ...
                  y2: 0,
                  colorStops: [{
                    offset: 0, color: (this.legend[0] && this.legend[0].color && this.legend[0].color[0]) || '#fcc204',
                  }, {
                    offset: 1, color: (this.legend[0] && this.legend[0].color && this.legend[0].color[1]) || '#ef6e18',
                  }],
                },
              },
              barWidth: 14,
            },
            {
              ...
              itemStyle: {
                color: {
                  ...
                  y2: 0,
                  colorStops: [{
                    offset: 0, color: (this.legend[1] && this.legend[1].color && this.legend[1].color[0]) || '#fcc204',
                  }, {
                    offset: 1, color: (this.legend[1] && this.legend[1].color && this.legend[1].color[1]) || '#ef6e18',
                  }],
                },
                opacity: (this.legend[1] && this.legend[1].opacity) || 1,
              },
              barWidth: 14,
            },
            // 排水左侧小标题
            ...
            },
            {
              ...
              itemStyle: {
                color: {
                  ...
                  y2: 0,
                  colorStops: [{
                    offset: 0, color: (this.legend[2] && this.legend[2].color && this.legend[2].color[0]) || '#fcc204',
                  }, {
                    offset: 1, color: (this.legend[2] && this.legend[2].color && this.legend[2].color[1]) || '#ef6e18',
                  }],
                },
                opacity: (this.legend[2] && this.legend[2].opacity) || 1,
              },
              label: {
                show: true,
                position: [440, -2],
        ...
        this.data.forEach((it) => {
          ...
          seriesData0.push({
            name: it.name,
            value: 0,
            sum: ((it.value1 && Number(it.value1)) || 0) + ((it.value2 && Number(it.value2)) || 0),
          });
          seriesData1.push({
            name: it.name,
